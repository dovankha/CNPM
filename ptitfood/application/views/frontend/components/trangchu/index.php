        ...
        <div class="container">
            <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 list-menu pull-left ptitfood-menu" style="height: 321px;">
                <div class="ptitfood-info">
                    <a href="#" class="info-item_link first-item"><i class="fas fa-school"></i>WELCOME TO PTITFOODX</a>
                    <ul class="info-list">
                        <li class="info-item">
                        ...
                        <li class="info-item">
                            <a href="#" class="info-item_link">ADMINISTRATOR</a>
                        </li>
                        <!-- <li class="info-item">
                            <a href="#" class="info-item_link">BẢN ĐỒ</a>
                        </li> -->
                    </ul>
                </div>
            </div>
            ...
            if((count($listProducts) >= 5)):?>
                <div class="list-product">
                    <div class="list-header-z">
                        <h2><a href="<?php echo  $rowCategory['link']?>"> <img src="http://localhost/ptitfoodx/public/images/hot.gif" alt=""> <?php echo  $rowCategory['name']?> nổi bật <img src="http://localhost/ptitfoodx/public/images/hot.gif" alt=""></a></h2>
...
<div class="container" style="margin-bottom: 20px;">
    ...
    <div class="sale-title">
        <span><i class="fas fa-cat"></i> KHUYẾN MÃI HOT</span>
...
<div class="container" style="margin-bottom: 20px;">
    <div class="recommend-prod">
        <div class="sale-title">
            <span><i class="fas fa-cat"></i> MÓN ĂN BÁN CHẠY NHẤT </span>
            <a href="#">XEM TẤT CẢ <i class="fas fa-chevron-right"></i></a>
        </div>
        <div class="owl-carousel owl-carousel-product owl-theme">
            <?php 
...
<!--=== CHATBOX ===-->
<script id="chatBroEmbedCode">/* Chatbro Widget Embed Code Start */function ChatbroLoader(chats,async){async=!1!==async;var params={embedChatsParameters:chats instanceof Array?chats:[chats],lang:navigator.language||navigator.userLanguage,needLoadCode:'undefined'==typeof Chatbro,embedParamsVersion:localStorage.embedParamsVersion,chatbroScriptVersion:localStorage.chatbroScriptVersion},xhr=new XMLHttpRequest;xhr.withCredentials=!0,xhr.onload=function(){eval(xhr.responseText)},xhr.onerror=function(){console.error('Chatbro loading error')},xhr.open('GET','//www.chatbro.com/embed.js?'+btoa(unescape(encodeURIComponent(JSON.stringify(params)))),async),xhr.send()}/* Chatbro Widget Embed Code End */ChatbroLoader({encodedChatId: '87tHb'});</script>
